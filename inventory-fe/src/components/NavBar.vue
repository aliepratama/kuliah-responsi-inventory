    ...
    <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 dark:bg-gray-800">
        <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
            ...
            <router-link to="/home" class="flex flex-col justify-start items-start">
                ...
                <span class="dark:text-white font-medium text-sm">Alie Pratama</span>
            </router-link>
            <div class="sm:hidden">
            ...
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                <router-link to="/home" class="font-medium text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-current="page">Home</router-link>
                <router-link to="/products" class="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Products</router-link>
            </div>
            </div>
        </nav>
    </header>
